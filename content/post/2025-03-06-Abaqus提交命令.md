...
![a6ed3616d120e0eeb3087d0596b3cb2b.png](/resources/a6ed3616d120e0eeb3087d0596b3cb2b.png)

使用以下命令行提交inp计算文件。
```Bash
abaqus job=[文件名]  cpus=[核心数] double=both output_precision=full int ask=off
```
![c410e740fc2aa52bde5adab8a2d1d217.png](/resources/c410e740fc2aa52bde5adab8a2d1d217.png)
